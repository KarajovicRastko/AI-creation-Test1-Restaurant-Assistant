...
LLM_MODEL = "deepseek-r1"  # TODO: izaberi model: "pozovi 'python main.py --models' da vidis dostupne modele

SYSTEM_PROMPT = "you are restaurant menu assistant. Please help customer choose from the menu. No changes, no substitutions."  # TODO: napisi system prompt za asistenta restorana
